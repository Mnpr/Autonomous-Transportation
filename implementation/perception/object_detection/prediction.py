...
def get_yolo_predictions(net, input_vid_path="io/sample.mp4", output_vid_path="io/yolo_output.avi", confidence_threshold=0.5, overlapping_threshold=0.3, write_output=False, show_display=True, labels = None):
